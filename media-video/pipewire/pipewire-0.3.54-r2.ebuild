...
pipewire-alsa sound-server ssl system-service systemd test udev v4l vanilla X zeroconf"
...
PATCHES=(
	...
	"${FILESDIR}"/${PN}-0.3.54-audioconvert-samples.patch
	"${FILESDIR}"/${PN}-0.3.54-fortify-source.patch
)
