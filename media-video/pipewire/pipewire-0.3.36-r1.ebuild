...
IUSE="bluetooth doc echo-cancel extra gstreamer jack-client jack-sdk pipewire-alsa systemd test udev v4l"
...
PATCHES=(
	...
	"${FILESDIR}"/${PN}-0.3.36-fix-crash-uaf-media-session.patch
	"${FILESDIR}"/${PN}-0.3.36-fix-version.patch
	"${FILESDIR}"/${PN}-0.3.36-missing-limits-include.patch
)
