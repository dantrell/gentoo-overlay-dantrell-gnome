...
inherit meson optfeature python-any-r1 udev multilib-minimal
...
multilib_src_configure() {
	local emesonargs=(
		...
		$(meson_native_feature bluetooth bluez5-codec-aac)
		$(meson_native_feature bluetooth bluez5-codec-aptx)
		$(meson_native_feature bluetooth bluez5-codec-ldac)
