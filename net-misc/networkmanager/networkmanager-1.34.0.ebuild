...
IUSE="audit bluetooth +concheck connection-sharing debug +dhclient dhcpcd elogind gnutls +gtk-doc +introspection iptables iwd kernel_linux psl libedit lto +nss nftables +modemmanager ofono ovs policykit +ppp resolvconf selinux syslog systemd teamd test +tools vala +vanilla +wext +wifi"
REQUIRED_USE="
