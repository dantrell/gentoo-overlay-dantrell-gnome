...
IUSE="audit bluetooth ck connection-sharing consolekit +dhclient dhcpcd elogind gnutls gtk-doc +introspection iwd kernel_linux +nss +modemmanager ncurses ofono ovs policykit +ppp resolvconf selinux systemd teamd test vala +vanilla +wext +wifi"
REQUIRED_USE="
