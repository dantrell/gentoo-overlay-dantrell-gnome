...
IUSE="audit bluetooth ck connection-sharing consolekit +dhclient dhcpcd doc elogind gnutls +introspection json kernel_linux +nss +modemmanager ncurses ofono policykit +ppp resolvconf selinux systemd teamd test vala +vanilla +wext +wifi"
REQUIRED_USE="
	doc? ( introspection )
	modemmanager? ( ppp )
	vala? ( introspection )
