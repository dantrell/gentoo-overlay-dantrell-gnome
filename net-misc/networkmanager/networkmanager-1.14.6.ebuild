...
inherit bash-completion-r1 gnome2 linux-info multilib python-any-r1 systemd readme.gentoo-r1 toolchain-funcs vala versionator virtualx udev multilib-minimal
