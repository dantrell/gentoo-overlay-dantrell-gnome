...
COMMON_DEPEND="
	|| ( >=app-accessibility/at-spi2-core-2.46.0[introspection?,${MULTILIB_USEDEP}] >=dev-libs/atk-2.10.0[introspection?,${MULTILIB_USEDEP}] )
...
src_prepare() {
	...
	eapply "${FILESDIR}"/${PN}-2.24.31-update-icon-cache.patch # requires eautoreconf
