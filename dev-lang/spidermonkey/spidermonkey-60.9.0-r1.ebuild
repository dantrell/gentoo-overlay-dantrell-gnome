...
# Patch version
FIREFOX_PATCHSET="firefox-60.9.0esr.source.tar.xz"
SPIDERMONKEY_PATCHSET="spidermonkey-60.0-patches-04.tar.xz"
...
PATCH_URIS=(
	https://dev.gentoo.org/~{anarchy,whissi,polynomial-c,axs}/mozilla/patchsets/${FIREFOX_PATCHSET}
...
src_prepare() {
	...
	eapply "${WORKDIR}"/spidermonkey
	eapply "${FILESDIR}"/spidermonkey-60.5.2-ia64-support.patch
