...
src_prepare() {
	...
	# 	https://cgit.freedesktop.org/telepathy/telepathy-mission-control/commit/?id=19f10ec2a59cadd4c59d6bc3147c612007c1c615
	eapply "${FILESDIR}"/${PN}-5.16.5-fix-string-max-size-calculation.patch
