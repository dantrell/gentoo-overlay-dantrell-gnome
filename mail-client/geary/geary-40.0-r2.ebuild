...
PATCHES=(
	"${FILESDIR}"/${PN}-40.0-Fix-accessibility-issues-with-initializer-of-constan.patch
	"${FILESDIR}"/${PN}-40.0-Util.Cache.Lru-Workaround-missing-generic-type-argum.patch
	"${FILESDIR}"/${PN}-40.0-Correct-the-conditional-comments-in-the-test-data.patch
)
