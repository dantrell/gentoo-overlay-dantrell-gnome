...
PATCHES=(
	# From GNOME:
	# 	https://gitlab.gnome.org/GNOME/geary/-/commit/7f155f87ac55e695f2a88a073c1f475657643e70
	"${FILESDIR}"/${PN}-3.38.2-engine-work-around-vapi-binding-change-causing-gmime-api-break.patch
)
