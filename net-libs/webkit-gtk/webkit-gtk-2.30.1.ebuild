...
IUSE="aqua deprecated +egl embedded +geolocation gles2-only gnome-keyring +gstreamer gtk-doc +introspection +jit jpeg2k +jumbo-build libnotify +opengl seccomp spell systemd wayland +webgl +X"
