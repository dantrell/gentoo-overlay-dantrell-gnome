...
# Missing WebRTC support, but ENABLE_MEDIA_STREAM/ENABLE_WEB_RTC is experimental upstream (PRIVATE OFF) and shouldn't be used yet in 2.34
...
src_prepare() {
	...
	eapply "${FILESDIR}"/${PN}-2.34.3-non-jumbo-fix.patch
	eapply "${FILESDIR}"/${PN}-2.34.3-jumbo-fix.patch # bug 830638
	cmake_src_prepare
	gnome2_src_prepare
}
