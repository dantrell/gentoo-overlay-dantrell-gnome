...
PATCHES=(
	...
	"${FILESDIR}"/${PN}-0.9.1-0001-rest_proxy_call_sync-bail-out-if-no-payload.patch
	"${FILESDIR}"/${PN}-0.9.1-0002-Handle-some-potential-problems-in-parsing-oauth2-acc.patch
)
