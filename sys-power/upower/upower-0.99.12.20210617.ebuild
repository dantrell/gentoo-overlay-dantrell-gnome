...
src_prepare() {
	...
	if ! use ck; then
		...
		#~eapply "${FILESDIR}"/${PN}-0.99.12-0037-ci-indent-the-dependencies.patch
		#~eapply "${FILESDIR}"/${PN}-0.99.12-0038-ci-add-abi-check.patch
	...
	if ! use ck; then
		...
		#~eapply "${FILESDIR}"/${PN}-0.99.12-0050-ci-ignore-changes-to-kind-enums.patch
		eapply "${FILESDIR}"/${PN}-0.99.12-0051-data-also-remove-hid-udev-rules.patch
		#~eapply "${FILESDIR}"/${PN}-0.99.12-0052-ci-export-the-tarball-in-the-artifacts.patch
	fi
