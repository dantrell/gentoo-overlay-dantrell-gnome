...
IUSE="dbus debug +elf elibc_glibc fam gtk-doc kernel_linux +mime selinux static-libs sysprof systemtap test xattr"
...
multilib_src_install() {
	...
	python_fix_shebang gio/gdbus-2.0/codegen/gdbus-codegen
	meson_src_install
