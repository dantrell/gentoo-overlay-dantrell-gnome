...
src_prepare() {
	default
	eapply "${FILESDIR}"/${PN}-2.5.0.4-dont-auto-run-epro-update-after-successful-sync.patch
	eapply "${FILESDIR}"/${PN}-2.5.0.4-leave-packages-and-foreign-repositories-alone.patch
}
